...
from tapir.coop.tests.test_welcome_desk_coop import TestWelcomeDeskBase
...
class TestWelcomeDeskShifts(TestWelcomeDeskBase):
    ...
    def test_normal_user_access_with_shift(self):
        ...
        normal_user = self.get_tapir_user_factory().create(is_in_member_office=False)
    ...
    def get_no_warnings_user(self):
        user = super().get_no_warnings_user()
